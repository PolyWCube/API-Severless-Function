...
const model = generator.getGenerativeModel({
	...
	systemInstruction: {
		parts: [
			...
			{ text: "The system information will be provided in the bracket '[' - ']', these will contain the system information. DO NOT COUNT IT AS THE REQUEST, only the count the one after the system provided information." }
		]
	}
});
